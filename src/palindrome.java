public class palindrome {
    ...
    public static void main(String[] args) {
        System.out.println(wordwisePalindrome("i read i")); // true
        System.out.println(wordwisePalindrome("hello world hello")); // true
        System.out.println(wordwisePalindrome("madam speaks madam")); // true
        System.out.println(wordwisePalindrome("i am i")); // false
    }
}
